<template>
  <div>
    <div
      class="circle-container canvas-outer-container"
...
.circle-container {
  ...
  * {
  ...
  .hidden-message {
    ...
    font-weight: 500;
    color: transparentize($moon-color, 0.3);
    user-select: none;
    letter-spacing: 2px;
    line-height: 38px;
    text-align: center;
  ...
  .moon-container {
    ...
    .moon-background {
      ...
      box-shadow:
        inset 0 0 100px 20px rgba(0, 0, 0, 0.35),
        0 0 50px transparentize(lighten($moon-color, 5), 0.9),
